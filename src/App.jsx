      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8">
          {[
            ...
            { icon: FaShieldAlt,    title: "Avaluüos y Proyectos",        description: "Asesoría en Avaluüos certificados, subdivisión de lotes y reglamentos de PH.",    color: "red-500",    delay: 0.6 },
          ].map((service, index) => {
