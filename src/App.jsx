      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="card-soft p-6 sm:p-8 border-2 border-primary/30 hover:border-primary/60 transition-all duration-300 group"
          >
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
            viewport={{ once: true }}
            className="card-soft p-6 sm:p-8 border-2 border-blue-500/30 hover:border-blue-500/60 transition-all duration-300 group"
          >
            <div className="flex items-center gap-4 mb-5 sm:mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-7 sm:mt-8 w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300"
            >
          ...
          {[
            {
              ...
              description:
                "Propiedades urbanas y rurales con verificación del estado jurídico completo.",
              color: "primary",
              delay: 0.1,
            },
            {
              ...
              description:
                "Gestión de contratos: vivienda, locales comerciales, turismo y aparcerías.",
              color: "blue-500",
              delay: 0.2,
            },
            {
              ...
              description:
                "Pertenencia, falsas tradiciones, pequeña propiedad rural (Ley 1561/2012).",
              color: "green-500",
              delay: 0.3,
            },
            {
              ...
              description:
                "Levantamiento de sucesiones notariales y representación en remates judiciales.",
              color: "purple-500",
              delay: 0.4,
            },
            {
              ...
              description:
                "Asesoría y gestión de financiación con bancos e inversionistas privados.",
              color: "orange-500",
              delay: 0.5,
            },
            {
            ...
            return (
              <motion.div
                ...
                className={`card-soft p-5 sm:p-6 text-center border border-slate-800 ${c.border} transition-all duration-300 group`}
              >
                <div
                  className={`w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 ${c.bg} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform`}
                >
                  <service.icon className={`${c.text} text-3xl sm:text-4xl`} />
                </div>
                <h3 className="text-light font-bold text-lg sm:text-xl mb-2 sm:mb-3">
                  {service.title}
                </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
          {[
            ...
            },
            {
              ...
              desc: "Te guiamos en todo el proceso",
              icon: FaUserTie,
            },
            {
              step: "03",
              title: "Verificación Legal",
              desc: "Revisamos todo jurídicamente",
              icon: FaBalanceScale,
            },
            {
              step: "04",
              title: "Cierre Exitoso",
              desc: "Tu negocio seguro y exitoso",
              icon: FaCheckCircle,
            },
          ].map((item, i) => (
            <motion.div
            ...
            >
              <div className="card-soft p-5 sm:p-6 text-center hover:border-primary/50 transition-all duration-300">
                <div className="text-primary text-5xl sm:text-6xl font-bold opacity-20 mb-2">
                  {item.step}
                </div>
    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="card-soft p-6 sm:p-10 lg:p-12 text-center border-2 border-primary/30"
        >
          <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-white mb-4 sm:mb-6">
            ¿Listo para dar el siguiente paso?
          </h2>
          <p className="text-slate-300 text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="button-gold inline-flex items-center justify-center gap-3 text-base sm:text-lg px-6 sm:px-8 py-3.5 sm:py-4"
            >
...
const ContactPage = () => (
  <div className="max-w-5xl mx-auto py-7 sm:py-12 lg:py-14 px-4 sm:px-6">
    ...
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
      className="text-center mb-7 sm:mb-12 lg:mb-14"
    >
      <h1 className="text-2xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white mb-2 sm:mb-4">
        Contáctanos
      </h1>
      <p className="text-slate-300 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
        Estamos aquí para ayudarte. Comunícate con nosotros por tu canal
        preferido y un asesor te atenderá de inmediato.
      </p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8 sm:mb-12 lg:mb-14">
      <motion.a
        ...
        className="bg-gradient-to-br from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 p-4 sm:p-7 rounded-2xl text-center shadow-xl hover:shadow-2xl transition-all duration-300 text-white group transform hover:-translate-y-1 hover:scale-[1.02]"
      >
      ...
      <motion.a
        ...
        className="bg-gradient-to-br from-pink-600 via-purple-600 to-indigo-600 hover:from-pink-500 hover:via-purple-500 hover:to-indigo-500 p-4 sm:p-7 rounded-2xl text-center shadow-xl hover:shadow-2xl transition-all duration-300 text-white group transform hover:-translate-y-1 hover:scale-[1.02]"
      >
      ...
      <motion.a
        ...
        className="bg-gradient-to-br from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 p-4 sm:p-7 rounded-2xl text-center shadow-xl hover:shadow-2xl transition-all duration-300 text-white group transform hover:-translate-y-1 hover:scale-[1.02]"
      >
      ...
      <motion.a
        ...
        className="bg-gradient-to-br from-yellow-500 to-yellow-600 hover:from-yellow-400 hover:to-yellow-500 p-4 sm:p-7 rounded-2xl text-center shadow-xl hover:shadow-2xl transition-all duration-300 text-slate-950 group transform hover:-translate-y-1 hover:scale-[1.02]"
      >
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
      <motion.div
        ...
        className="card-soft p-5 sm:p-8"
      >
        <h2 className="text-lg sm:text-2xl font-bold text-primary mb-5">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-light font-semibold mb-2">
      ...
      <motion.div
        ...
        className="card-soft p-2 h-full min-h-[260px] sm:min-h-[380px]"
      >
        <iframe
          ...
          width="100%"
          height="100%"
          style={{ border: 0, borderRadius: "12px", minHeight: "260px" }}
          allowFullScreen=""
          loading="lazy"
    ...
    <motion.div
      ...
      className="text-center mt-8 sm:mt-12 p-5 sm:p-8 card-soft"
    >
      <h2 className="text-xl sm:text-3xl font-bold text-primary mb-2 sm:mb-4">
        ¿Listo para dar el siguiente paso?
      </h2>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="button-gold inline-flex items-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4"
      >
